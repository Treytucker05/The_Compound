...
- Annotations expire when their session ends unless a Member explicitly invokes **Save Annotation**.
...
- Annotation content is not silently placed in session history or beside an underlying project file.
