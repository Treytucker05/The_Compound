...
- **Computer Session Approval**: The target computer owner’s explicit approval of a requested Computer Session. Every full-computer session needs a new approval and then follows Controlled Session rules; neither private-network access nor project sharing substitutes for it.
